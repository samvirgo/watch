...
<body>
 ...
 <!-- begin HOME/LOGOUT ACTIONS -->
       ...
       <br><br>    <br><br> <img class="img-circle img-logout" src="img/osman1.jpg" alt="">
		...
		include("execute/connect.php");
		$select_posts="SELECT * FROM contact order by `post_id` desc LIMIT 0, 4";
		...
		while($row=mysql_fetch_array($run_posts)){
			...
			?>
                 ...
                 <h3 >Recieved Date: <?php echo $post_date;?></h3>
                <div class="well  portlet portlet-blue">
                    <h4>Name:<?php echo $post_name;?></h4>
