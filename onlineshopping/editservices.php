...
<body>
 ...
 <!-- begin HOME/LOGOUT ACTIONS -->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-edit"></i> Edit Services
                            </li>
                        </ol>
                    </div>
                </div>
				...
				<br/>
					<div class="panel panel-smart">
						<div class="panel-heading">
							<h3 class="panel-title">Services<i class="fa fa-fw fa-angle-double-right"></i>Edit Here</h3>
						</div>
						<br/>
      ...
      if(isset($_GET['edit'])){
      $edit_id =$_GET['edit'];
      $edit_query = "select * from services where post_id='$edit_id'";
   ...
   $post_desc= $edit_row['post_desc'];
       ...
       ?>
						<!-- Registration Form Starts -->
							<form class="form-horizontal" method="post" action="editservices.php?edit_form=<?php echo $post_id;?>">
...
$post_title1 =$_POST['title'];
 ...
 if($post_title1=='' or $post_desc1==''){
  ...
  $update_query ="update services set post_title='$post_title1',post_desc='$post_desc1' where post_id
   ='$update_id'";
 ...
 echo "<script> window.open('editservices.php','_self')</script>";
