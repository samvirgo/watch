                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-plus-circle"></i> insert new post
                            </li>
                        </ol>
                    </div>
                </div>
...
if($post_title=="" or $post_desc=="" or $post_price=="" ){
echo "<script>alert('any of the feild is empty')</script>";
exit();
}
else{
       move_uploaded_file($img_tmp,"img/$post_image");

$insert_query="insert into ads(post_title,post_date,post_desc,post_price,post_image) values
('$post_title','$post_date','$post_desc','$post_price','$post_image')";
				...
				<br/>
					<div class="panel panel-smart">
						<div class="panel-heading">
							<h3 class="panel-title">Insert Your Post Here</h3>
						</div>
						<br/>
						...
						<!-- adds insertion Form Starts -->
							...
							<!-- description Area Starts -->
								...
								<div class="form-group">
									...
									<div class="col-sm-7">
									<textarea rows="15%"  class="form-control" name="desc" placeholder="description"></textarea>
									</div>
								</div>
