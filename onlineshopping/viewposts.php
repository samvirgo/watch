				...
				<div class="row">
					<div class="col-lg-12">
						...
						<ol class="breadcrumb">
							...
							<li class="active"><i class="fa fa-eye"></i> view all posts</li>
						</ol>
					</div>
				</div>
				<!-- /.row -->
					...
					<div class="col-lg-12">
						...
						<div class="table-responsive">
							<table
								...
								<thead>
								<tr>
										<td colspan="8" align="center" bgcolor="#54677a"><h1>View All
												Posts</h1></td>
									</tr>
									<tr>
										<th>Post No</th>
...
if ($last!=1){
	if($pagenum>1){
		$pre=$pagenum-1;
		$pagination.='<li><a href="viewposts.php?pn='.$pre.'">&laquo;</a></li>';
		
		for ($i=$pagenum-4; $i<$pagenum; $i++){
			if($i>0){
				$pagination.="<li><a href='viewposts.php?pn=".$i."'>".$i."</a></li>";
			}
		}
	}
	...
	if($pagenum!=$last){
		$next=$pagenum+1;
		$pagination.="<li><a href='viewposts.php?pn=".$next."'>&raquo;</a></li>";
	}
}
		...
		while($row=mysql_fetch_array($query)){
			...
			?>
									<tr align="center">
										...
										<td><i class="fa fa-fw fa-pencil"></i><a
											href="edit.php?edit=<?php echo $post_id; ?>">Edit</a></td>
