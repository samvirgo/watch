       ...
       <br><br>    <br><br> <img class="img-circle img-logout" src="img/osman1.jpg" alt="">
        ...
        <div id="page-wrapper">
			...
			<div class="col-sm-1">
				...
				<div class="col-sm-10">
				<!-- adds insertion Block Starts -->
				<br/>
					<div class="panel panel-smart">
						<div class="panel-heading">
							<h3 class="panel-title">Edit Your Post Here</h3>
						</div>
						<br/>
...
<?php
      ...
      if(isset($_GET['edit'])){
      $edit_id =$_GET['edit'];
      $edit_query = "select * from ads where post_id='$edit_id' ";
   ...
   $post_image= $edit_row['post_image'];
       ...
       ?>
					<!-- adds insertion Form Starts -->
							<form class="form-horizontal"  action="edit.php?edit_form=<?php echo $post_id;?>" 
							...
							<!-- description Area Starts -->
								...
								<div class="form-group">
									...
									<div class="col-sm-7">
									<textarea rows="15%"  class="form-control" name="desc" placeholder="description">
							...
							<!-- price Area Starts -->
								...
								<div class="form-group">
									<label for="inputEmail" class="col-sm-3 control-label" >Price</label>
									<div class="col-sm-2">
								...
								<div class="form-group">
								<label for="file" class="col-sm-3 control-label" >Select Your Image</label>
									<div class="col-sm-4">
										<input type="file" class="form-control"  name="image" >
										<img src="img/<?php echo $post_image; ?>" width="200" height="200">
									</div>
								</div>
							<!-- submition Starts -->
...
$post_title1 =$_POST['title'];
 ...
 move_uploaded_file($img_tmp,"img/$post_image1");

   $update_query ="update ads set post_title='$post_title1',
   post_date='$post_date1',post_desc='$post_desc1',post_price=
  '$post_price1',post_image='$post_image1' where post_id
   ='$update_id'";
